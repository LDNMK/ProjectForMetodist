function initSidebar(){let e=document.body.querySelectorAll("a[data-page*='-page'");e.forEach(e=>{e.addEventListener("click",e=>{setPageByAttribute(e.target.getAttribute("data-page"))})})}function subscribeFormElements(){let e=document.body.querySelectorAll(".form-element-field");e.forEach(e=>e.addEventListener("change",e=>{let l=e.target;l.classList[l.value?"add":"remove"]("-hasValue")}))}const optionDefault='<option class="form-select-placeholder" value="" disabled selected></option>';class Page{constructor(){}static getPage(){return"not implemented"}static init(){console.log("not initialized")}static get is(){return"Page"}static _idsToClear(){return[]}}class MainPage extends Page{constructor(){super()}static get page(){return`
        ...
        `}static init(){this._initDataObjKeyFields(),this._studentCardSubscribe(),subscribeFormElements()}static _initDataObjKeyFields(){this._dataObjKeyFields=content.querySelectorAll("[data-obj-key]")}static _studentCardSubscribe(){const e=document.querySelector(".student-card__show-btn-save"),s=document.querySelector("#group"),l=document.querySelector("#course");e.addEventListener("click",()=>{!async function(){let l={};StudentCardAddPage._dataObjKeyFields.forEach(e=>{l[e.getAttribute("data-obj-key")]=e.value}),console.log(l);await fetch("api/StudentCard/SaveStudentCardInfo",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(l)})}()}),l.addEventListener("change",()=>{!async function(l){if(""!=l){const t=await fetch(`api/Group/GetListOfGroups?course=${l}`),a=await t.json();console.log(a);let e=a.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),s.innerHTML=e.join(""),s.classList.remove("-hasValue")}}(l.value)});var t=new Event("change");l.dispatchEvent(t)}}StudentCardAddPage.is="test";class StudentCardShowPage extends Page{constructor(){super()}static _dataObjKeyFields=null;static get is(){return"student-card--show-page"}static get page(){return`
        ...
        `}static init(){this._initDataObjKeyFields(),this._studentCardSubscribe(),subscribeFormElements()}static _initDataObjKeyFields(){this._dataObjKeyFields=content.querySelectorAll("[data-obj-key]")}static _studentCardSubscribe(){const e=document.querySelector(".student-card__show-btn-clear"),l=document.querySelector(".student-card__show-btn-find"),t=document.querySelector(".student-card__show-btn-edit"),a=document.querySelector(".student-card__show-btn-save"),s=document.querySelector(".student-card__show-average-score-btn"),o=document.querySelector("#group"),i=document.querySelector("#course"),n=document.querySelector("#student"),r=document.querySelector("#year");e.addEventListener("click",()=>{let e=this._idsToClear(),l=document.querySelectorAll(e.join(", "));l.forEach(e=>{e.classList.remove("-hasValue"),e.value=""})}),l.addEventListener("click",()=>{!async function(e){if(""!=e){const l=await fetch(`api/StudentCard/ShowStudentInfo?studentId=${e}`),t=await l.json();StudentCardShowPage._dataObjKeyFields.forEach(e=>{e.value=t[e.getAttribute("data-obj-key")],e.classList.add("-hasValue")}),console.log(t)}}(n.value)}),t.addEventListener("click",()=>{console.log("Edit")}),a.addEventListener("click",()=>{!async function(e){let l={};StudentCardShowPage._dataObjKeyFields.forEach(e=>{l[e.getAttribute("data-obj-key")]=e.value}),console.log(l);await fetch(`api/StudentCard/UpdateStudentCardInfo?studentId=${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(l)})}(n.value)}),s.addEventListener("click",()=>{console.log("Average score")}),r.addEventListener("change",()=>{d(r.value,i.value)}),i.addEventListener("change",()=>{d(r.value,i.value)}),o.addEventListener("change",()=>{!async function(l){if(""!=l){const t=await fetch(`api/StudentCard/GetListOfStudents?groupId=${l}`),a=await t.json();let e=a.map(e=>`<option value=${e.studentId}>${e.studentName}</option>`);e.push(optionDefault),n.innerHTML=e.join(""),n.classList.remove("-hasValue")}}(o.value)});async function d(l,t){if(""!=l&&""!=t){const a=await fetch(`api/Group/GetListOfGroups?course=${t}&year=${l}`),s=await a.json();console.log(s);let e=s.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),o.innerHTML=e.join(""),o.classList.remove("-hasValue")}}r.value=2021,r.classList.add("-hasValue"),i.value="1",i.classList.add("-hasValue");var c=new Event("change");i.dispatchEvent(c)}static _idsToClear(){return["#speciality","#specialization","#year","#course","#group","#student"]}}class GroupAddPage extends Page{constructor(){super()}static get is(){return"group--add-page"}static get page(){return`
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static _groupCardSubscribe(){const e=document.querySelector(".group__add__btn-save"),l=document.querySelector("#year"),t=document.querySelector("#name");e.addEventListener("click",()=>{!async function(e,l){""!=e&&""!=l&&await fetch(`api/Group/CreateGroup?groupName=${l}`,{method:"POST"})}(l.value,t.value)})}}class GroupActualizePage extends Page{constructor(){super()}static get is(){return"group--actualize-page"}static get page(){return`
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static _groupCardSubscribe(){let o=document.querySelector(".group__actualize-items"),a=document.querySelector("#group");const e=document.querySelector(".group__actualize-btn-add"),l=document.querySelector(".group__actualize-btn-actualize");e.addEventListener("click",()=>{!function(a,s){if(""!=s&&""!=a){let e=document.createElement("li");e.classList.add("group__actualize-item"),e.setAttribute("data-group-id",s);let l=document.createElement("i");l.classList.add("fas","fa-minus-square"),l.addEventListener("click",()=>{o.removeChild(e)});let t=document.createElement("span");t.innerText=a,e.insertAdjacentElement("beforeend",l),e.insertAdjacentElement("beforeend",t),o.insertAdjacentElement("beforeend",e)}}(a.options[a.selectedIndex].text,a.value)}),l.addEventListener("click",()=>{var e=[...o.children].map(e=>+e.getAttribute("data-group-id")).filter((e,l,t)=>t.indexOf(e)===l);console.log(e),async function(e){e.length<=0||(await fetch("api/Group/ActivateExistingGroups",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).ok&&(o.innerHTML="",t())}(e)});async function t(){const e=await fetch("api/Group/GetDeactivatedGroups",{method:"GET"}),l=await e.json();let t=l.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);t.push(optionDefault),a.innerHTML=t.join(""),a.classList.remove("-hasValue")}window.onload=t()}}let content=document.body.querySelector(".main__content");content||console.log("Tag with class'main__content' not found!");const mapper={"main--page":MainPage,"student-card--add-page":StudentCardAddPage,"student-card--show-page":StudentCardShowPage,"group--add-page":GroupAddPage,"group--actualize-page":GroupActualizePage};function setPageByAttribute(l){if(l in mapper){let e=mapper[l];content.innerHTML=e.page,e.init()}else console.log(`Tag with attribute data-page='${l}' not found!`)}function init(){initSidebar(),GroupActualizePage.init()}init();