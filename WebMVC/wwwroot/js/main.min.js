function initSidebar(){let e=document.body.querySelectorAll("a[data-page*='-page'");e.forEach(e=>{e.addEventListener("click",e=>{setPageByAttribute(e.target.getAttribute("data-page"))})})}function subscribeFormElements(){let e=document.body.querySelectorAll(".form-element-field");e.forEach(e=>e.addEventListener("change",e=>{let l=e.target;l.classList[l.value?"add":"remove"]("-hasValue")}))}const optionDefault='<option class="form-select-placeholder" value="" disabled selected></option>';class Page{constructor(){}static getPage(){return"not implemented"}static init(){console.log("not initialized")}static get is(){return"Page"}static _idsToClear(){return[]}}class MainPage extends Page{constructor(){super()}static get page(){return`
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static _groupCardSubscribe(){let o=document.querySelector(".group__actualize-items"),e=document.querySelector("#group");const l=document.querySelector(".group__actualize__btn-add");l.addEventListener("click",()=>{!function(a,s){if(console.log(`id: ${s} name: ${a}`),""!=s&&""!=a){let e=document.createElement("li");e.classList.add("group__actualize-item"),e.setAttribute("data-group-id",s);let l=document.createElement("i");l.classList.add("fas","fa-trash-alt"),l.addEventListener("click",()=>{o.removeChild(e)});let t=document.createElement("span");t.innerText=a,e.insertAdjacentElement("beforeend",l),e.insertAdjacentElement("beforeend",t),o.insertAdjacentElement("beforeend",e)}}(e.options[e.selectedIndex].text,e.value)})}}let content=document.body.querySelector(".main__content");content||console.log("Tag with class'main__content' not found!");const mapper={"main--page":MainPage,"student-card--add-page":StudentCardAddPage,"student-card--show-page":StudentCardShowPage,"group--add-page":GroupAddPage,"group--actualize-page":GroupActualizePage};function setPageByAttribute(l){if(l in mapper){let e=mapper[l];content.innerHTML=e.page,e.init()}else console.log(`Tag with attribute data-page='${l}' not found!`)}function init(){initSidebar(),setPageByAttribute(GroupActualizePage.is)}init();