function initSidebar(){let e=document.body.querySelectorAll("a[data-page*='-page'"),t=document.body.querySelectorAll(".sidebar__menu-item");e.forEach(e=>{e.addEventListener("click",e=>{setPageByAttribute(e.target.getAttribute("data-page")),t.forEach(e=>e.classList.remove("active")),e.target.closest(".sidebar__menu-item").classList.add("active")})})}function getGroupItemWithButton(e,t,l){return""==t||""==e||null==l?null:`
        ...
        <div class="progress__row progress__row-student" data-student-id="${e.id}">
            ...
            <div class="progress__row-cell progress__row-cell-final-mark">
                <span data-student-final>
                    ${Math.round(e.subjects.map(e=>e.mark)?.reduce((e,t)=>e+=t,0)/e.subjects.length)}
    ...
    `}function subscribeFormElements(){let e=document.body.querySelectorAll(".form-element-field");e.forEach(e=>e.addEventListener("change",e=>{let t=e.target;t.classList[t.value?"add":"remove"]("-hasValue")}))}const optionDefault='<option class="form-select-placeholder" value="" disabled selected></option>';class Page{constructor(){}static getPage(){return"not implemented"}static init(){console.log("not initialized")}static get is(){return"Page"}static _idsToClear(){return[]}}class MainPage extends Page{constructor(){super()}static get page(){return`
        ...
        `}static init(){this._subscribePageElements(),subscribeFormElements()}static _subscribePageElements(){const t=document.querySelector(".curriculum__table"),s=document.querySelector(".curriculum__table-row-last"),e=document.querySelector("#add-row-btn"),i=document.querySelector("#plan-id"),o=document.querySelector("#plan-name"),l=document.querySelector("#year"),a=document.querySelector("#course"),r=document.querySelector("#group"),n=document.querySelector(".curriculum__btn-find"),c=document.querySelector(".curriculum-info__btn-edit"),d=document.querySelector(".curriculum-info__btn-save");l.addEventListener("change",()=>{u(a.value,l.value)}),a.addEventListener("change",()=>{u(a.value,l.value)}),n.addEventListener("click",()=>{!async function(e,t){if(""!=e){const l=await fetch(`api/YearPlan/GetYearPlanByGroup?groupId=${e}&year=${t}`);if(console.log(l),l.ok){const a=await l.json();console.log(a),i.value=a.id,i.classList.add("-hasValue"),o.value=a.name,o.classList.add("-hasValue"),a.subjectInfo.forEach(e=>{s.insertAdjacentHTML("beforebegin",addCurriculumRow(e))})}else console.log("Year plan not found")}}(r.value,l.value)}),c.addEventListener("click",()=>{let e=t.querySelectorAll("[data-is-disabled]");e.forEach(e=>{e.disabled=!e.disabled})}),d.addEventListener("click",()=>{!async function(e){if(""!=e){let a={id:e,name:o.value,year:l.value,groupdIds:[r.value],subjectInfo:[]},s=t.querySelectorAll(".curriculum__table-row-data");for(let e=0;e<s.length;e++){let t=s[e].querySelectorAll("[data-table-key]"),l={};for(let e=0;e<t.length;e++)l[t[e].getAttribute("data-table-key")]=t[e]["checkbox"==t[e].type?"checked":"value"];a.subjectInfo.push(l)}console.log(a);await fetch(`api/YearPlan/UpdateYearPlan?yearPlanId=${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)})}}(i.value)});async function u(t,l){if(""!=t){t=`api/Group/GetListOfGroups?course=${t}`;t+=l?`&year=${l}`:"";const a=await fetch(t),s=await a.json();let e=s.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),r.innerHTML=e.join(""),r.classList.remove("-hasValue")}}e.addEventListener("click",()=>{e.hasAttribute("disabled")||s.insertAdjacentHTML("beforebegin",addCurriculumRow())})}}class GroupAddPage extends Page{constructor(){super()}static get is(){return"group--add-page"}static get page(){return`
        ...
        `}static init(){this._subscribePageElements(),subscribeFormElements()}static _subscribePageElements(){const e=document.querySelector("#year"),t=document.querySelector("#course"),i=document.querySelector("#group"),l=document.querySelector("#semestr"),o=document.querySelector(".progress__table"),r=document.querySelector(".progress__row-cell-subjects"),a=document.querySelector(".progress__btn-find"),s=document.querySelector(".progress__btn-edit"),n=document.querySelector(".progress__btn-save");e.addEventListener("change",()=>{}),t.addEventListener("change",()=>{!async function(t,l){if(""!=t){t=`api/Group/GetListOfGroups?course=${t}`;t+=l?`&year=${l}`:"";const a=await fetch(t),s=await a.json();let e=s.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),i.innerHTML=e.join(""),i.classList.remove("-hasValue")}}(t.value)}),a.addEventListener("click",()=>{!async function(e,t,l){if(""!=e&&""!=t&&""!=l){!function(){let l=o.querySelectorAll(".progress__row-cell-subject");for(let e=0,t=l.length;e<t;e++)l[e].remove();let a=o.querySelectorAll(".progress__row-student");for(let e=0,t=a.length;e<t;e++)a[e].remove()}();l=`api/Progress/GetProgress?year=${e}&groupId=${t}&semesterId=${l}`;console.log(l);const a=await fetch(l),s=await a.json();s.subjects.forEach(e=>{r.insertAdjacentHTML("beforeend",getProgressSubjectCell(e))}),s.students.forEach(e=>{o.insertAdjacentHTML("beforeend",getProgressStudentRow(e,s.subjects))}),console.log(s)}}(e.value,i.value,l.value)}),s.addEventListener("click",()=>{let e=o.querySelectorAll(".progress__row-cell-marks input");e.forEach(e=>{e.disabled=!e.disabled})}),n.addEventListener("click",()=>{let l=[],e=o.querySelectorAll(".progress__row-student");e.forEach(e=>{let t={id:e.getAttribute("data-student-id"),name:e.querySelector(".progress__row-cell-student span")?.innerText};t.subjects=[...e.querySelectorAll(".progress__row-cell-input")].map(e=>({id:+e.getAttribute("data-subject-id"),mark:""==e.value?null:e.value})),l.push(t)}),async function(e){console.log(e),console.log(JSON.stringify(e));e=await fetch("api/Progress/UpdateProgress",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});console.log(e)}(l)})}}let content=document.body.querySelector(".main__content");content||console.log("Tag with class'main__content' not found!");const mapper={"main--page":MainPage,"student-card--add-page":StudentCardAddPage,"student-card--show-page":StudentCardShowPage,"curriculum--show-page":CurriculumShowPage,"curriculum--add-page":CurriculumAddPage,"transfer--page":TransferPage,"progress--page":ProgressPage,"create-report--page":CreateReportPage,"group--add-page":GroupAddPage,"group--actualize-page":GroupActualizePage};function setPageByAttribute(t){if(t in mapper){let e=mapper[t];content.innerHTML=e.page,e.init()}else console.log(`Tag with attribute data-page='${t}' not found!`)}function init(){initSidebar(),setPageByAttribute(CurriculumAddPage.is)}init();