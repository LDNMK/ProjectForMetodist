function initSidebar(){let e=document.body.querySelectorAll("a[data-page*='-page'"),t=document.body.querySelectorAll(".sidebar__menu-item");e.forEach(e=>{e.addEventListener("click",e=>{setPageByAttribute(e.target.getAttribute("data-page")),t.forEach(e=>e.classList.remove("active")),e.target.closest(".sidebar__menu-item").classList.add("active")})})}function getGroupItemWithButton(e,t,a){return""==t||""==e||null==a?null:`
    ...
    `}function subscribeFormElements(){let e=document.body.querySelectorAll(".form-element-field");e.forEach(e=>e.addEventListener("change",e=>{let t=e.target;t.classList[t.value?"add":"remove"]("-hasValue")}))}const optionDefault='<option class="form-select-placeholder" value="" disabled selected></option>';class Page{constructor(){}static getPage(){return"not implemented"}static init(){console.log("not initialized")}static get is(){return"Page"}static _idsToClear(){return[]}}class MainPage extends Page{constructor(){super()}static get page(){return`
        ...
        `}static init(){this._initDataObjKeyFields(),this._studentCardSubscribe(),subscribeFormElements()}static _initDataObjKeyFields(){this._dataObjKeyFields=content.querySelectorAll("[data-obj-key]")}static _studentCardSubscribe(){const e=document.querySelector(".student-card__show-btn-find"),t=document.querySelector(".student-card__show-btn-edit"),a=document.querySelector(".student-card__show-btn-save"),l=document.querySelector(".student-card__show-average-score-btn"),o=document.querySelector("#group"),s=document.querySelector("#course"),r=document.querySelector("#student"),i=document.querySelector("#speciality"),n=document.querySelector("#select-year"),c=document.querySelector("#year");e.addEventListener("click",()=>{!async function(e){if(""!=e){const t=await fetch(`api/StudentCard/ShowStudentInfo?studentId=${e}`),a=await t.json();console.log(a),StudentCardShowPage._dataObjKeyFields.forEach(e=>{e.value=a[e.getAttribute("data-obj-key")],e.value&&e.classList.add("-hasValue")}),console.log(a)}}(r.value)}),t.addEventListener("click",()=>{this._dataObjKeyFields.forEach(e=>{e.disabled=!e.disabled})}),a.addEventListener("click",()=>{!async function(e){let t={};StudentCardShowPage._dataObjKeyFields.forEach(e=>{t[e.getAttribute("data-obj-key")]=e.value}),console.log(t);await fetch(`api/StudentCard/UpdateStudentCardInfo?studentId=${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}(r.value)}),l.addEventListener("click",()=>{console.log("Average score")}),n.addEventListener("change",()=>{c.disabled=!n.checked,n.checked||(c.value="",c.classList.remove("-hasValue"),s.dispatchEvent(new Event("change")))}),c.addEventListener("change",()=>{d(s.value,c.value)}),s.addEventListener("change",()=>{n.checked&&!c.value?console.log("Error: year wasn't selected"):n.checked&&c.value?d(s.value,c.value):d(s.value)}),o.addEventListener("change",()=>{!async function(t){if(""!=t){const a=await fetch(`api/StudentCard/GetListOfStudents?groupId=${t}`),l=await a.json();let e=l.map(e=>`<option value=${e.studentId}>${e.studentName}</option>`);e.push(optionDefault),r.innerHTML=e.join(""),r.classList.remove("-hasValue")}}(o.value)});async function d(a,l=null){if(""!=l&&""!=a){let e=`api/Group/GetListOfGroups?course=${a}`;l&&(e+=`&year=${l}`);const s=await fetch(e),i=await s.json();console.log(i);let t=i.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);t.push(optionDefault),o.innerHTML=t.join(""),o.classList.remove("-hasValue"),r.value="",r.innerHTML=optionDefault,r.classList.remove("-hasValue")}}window.onload=async function(){const e=await fetch("api/StudentCard/GetSpecialities"),t=await e.json();let a=t.map(e=>`<option value=${e.id}>${e.name}</option>`);a.push(optionDefault),i.innerHTML=a.join(""),i.classList.remove("-hasValue")}()}static _idsToClear(){return["#speciality","#specialization","#year","#course","#group","#student"]}}class CurriculumAddPage extends Page{constructor(){super()}static get is(){return"curriculum--add-page"}static _counter=1;static get page(){return`
        ...
        `}static init(){this._subscribePageElements(),subscribeFormElements()}static _subscribePageElements(){const t=document.querySelector(".curriculum__table"),l=document.querySelector(".curriculum__table-row-last"),e=document.querySelector("#add-row-btn"),s=document.querySelector("#plan-name"),a=document.querySelector("#year"),i=document.querySelector("#course"),o=document.querySelector("#group"),r=document.querySelector("#plan"),n=document.querySelector(".curriculum__btn-find"),c=document.querySelector(".curriculum-info__btn-edit"),d=document.querySelector(".curriculum-info__btn-save");a.addEventListener("change",()=>{u(i.value,a.value),m(o.value,a.value)}),i.addEventListener("change",()=>{u(i.value)}),o.addEventListener("change",()=>{m(o.value,a.value)}),n.addEventListener("click",()=>{!async function(e){if(""!=e){const t=await fetch(`api/YearPlan/ShowYearPlan?yearPlanId=${e}`),a=await t.json();s.value=a.name,s.classList.add("-hasValue"),console.log(a),a.subjectInfo.forEach(e=>{l.insertAdjacentHTML("beforebegin",addCurriculumRow(e))})}}(r.value)}),c.addEventListener("click",()=>{let e=t.querySelectorAll("[data-is-disabled]");e.forEach(e=>{e.disabled=!e.disabled})}),d.addEventListener("click",()=>{!async function(e){""!=e&&(console.log(yearPlan),await fetch(`api/YearPlan/UpdateYearPlan?yearPlanId=${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(yearPlan)}))}(r.value)});async function u(t,a){if(""!=t){t=`api/Group/GetListOfGroups?course=${t}`;t+=a?`&year=${a}`:"";const l=await fetch(t),s=await l.json();let e=s.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),o.innerHTML=e.join(""),o.classList.remove("-hasValue")}}async function m(t,a){if(""!=t&&""!=a){const l=await fetch(`api/YearPlan/GetYearPlanByGroup?groupId=${t}&year=${a}`);a=await l.json();console.log(a);let e=`<option value=${a.planId}>${a.planName}</option>`;e.push(optionDefault),r.innerHTML=e.join(""),r.classList.remove("-hasValue")}}e.addEventListener("click",()=>{e.hasAttribute("disabled")||l.insertAdjacentHTML("beforebegin",addCurriculumRow())})}}class GroupAddPage extends Page{constructor(){super()}static get is(){return"group--add-page"}static get page(){return`
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static _groupCardSubscribe(){const t=document.querySelector("#select-student"),e=document.querySelector("#course"),s=document.querySelector("#group"),i=document.querySelector("#student"),o=document.querySelector(".btn-clear"),a=[document.querySelector(".transfer__btn-transfer"),document.querySelector(".transfer__btn-vacation"),document.querySelector(".transfer__btn-leave"),document.querySelector(".transfer__btn-remove"),document.querySelector(".transfer__btn-resume")];a.forEach(e=>{e.addEventListener("click",()=>{t.checked&&!i.value?console.log("Error: the student wasn't select"):i.value?async function(e){s.value,i.value;console.log(e)}(e.getAttribute("data-transfer-key")):async function(){console.log("transfer group")}(s.value)})}),o.addEventListener("click",()=>{i.classList.remove("-hasValue"),i.value="",o.classList.add("btn-hide"),l(!i.value)}),s.addEventListener("change",()=>{!async function(t){if(""!=t){const a=await fetch(`api/StudentCard/GetListOfStudents?groupId=${t}`),l=await a.json();let e=l.map(e=>`<option value=${e.studentId}>${e.studentName}</option>`);e.push(optionDefault),i.innerHTML=e.join(""),i.classList.remove("-hasValue"),o.dispatchEvent(new Event("click"))}else i.innerHTML=""}(s.value)}),t.addEventListener("click",()=>{i.disabled=!t.checked,t.checked||o.dispatchEvent(new Event("click"))}),e.addEventListener("change",()=>{!async function(t){if(""!=t){const a=await fetch(`api/Group/GetListOfGroups?course=${t}`),l=await a.json();let e=l.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),s.innerHTML=e.join(""),s.classList.remove("-hasValue"),o.dispatchEvent(new Event("click")),i.innerHTML=""}}(e.value)}),i.addEventListener("change",()=>{o.classList[i.value?"remove":"add"]("btn-hide"),l(!i.value)});async function l(t){a.forEach(e=>{e.classList.contains("transfer__btn-transfer")||(e.disabled=t)})}}}class CreateReportPage extends Page{constructor(){super()}static get is(){return"create-report--page"}static get page(){return`
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static _groupCardSubscribe(){const e=document.querySelector("#course"),t=document.querySelector("#year"),o=document.querySelector("#group"),r=document.querySelector("#student"),a=document.querySelector(".create-report__create-btn");e.addEventListener("change",()=>{console.log("course"),t.value?l(e.value,t.value):l(e.value)}),t.addEventListener("change",()=>{t.value?l(e.value,t.value):l(e.value)}),o.addEventListener("change",()=>{!async function(t){if(""!=t){const a=await fetch(`api/StudentCard/GetListOfStudents?groupId=${t}`),l=await a.json();let e=l.map(e=>`<option value=${e.studentId}>${e.studentName}</option>`);e.push(optionDefault),r.innerHTML=e.join(""),r.classList.remove("-hasValue")}}(o.value)}),a.addEventListener("click",()=>{!async function(e){if(""!=e){const t=await fetch(`api/Report/CreateReport?studentId=${e}`);await t.json()}}(r.value)});async function l(a,l=null){if(""!=a){let e=`api/Group/GetListOfGroups?course=${a}`;l&&(e+=`&year=${l}`);const s=await fetch(e),i=await s.json();console.log(i);let t=i.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);t.push(optionDefault),o.innerHTML=t.join(""),o.classList.remove("-hasValue"),r.value="",r.innerHTML=optionDefault,r.classList.remove("-hasValue")}}}}class ProgressPage extends Page{constructor(){super()}static get is(){return"progress--page"}static get page(){return`
