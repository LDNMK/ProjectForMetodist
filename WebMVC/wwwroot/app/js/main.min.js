const msgContainer=document.querySelector(".notification__list"),content=document.body.querySelector(".main__content"),notificationTimeout={success:5e3,warning:6e3,error:6e3},notificationTitle={success:"Успішно",warning:"Попередження",error:"Помилка"},notificationIcons={success:'<i class="success-icon fas fa-check-circle"></i>',warning:'<i class="warning-icon fas fa-exclamation-circle"></i>',error:'<i class="error-icon fas fa-times-circle"></i>'};class ApiHelper{async _callApi(e,t){const a=await fetch(e,t);t=await a.json();return t.notificationType?(NotificationHelper.addNotification(t.notificationType,t.notificationText),t.data):t}async fetchCreateGroup(e){await this._callApi(`api/Group/CreateGroup?groupName=${e}`,{method:"POST"})}async fetchGetGroups(e,t){return await this._callApi(`api/Group/GetGroups?course=${e}${t?`&year=${t}`:""}`)}async fetchGetStudents(e,t){return await this._callApi(`api/StudentCard/GetStudents?groupId=${e}${t?`&year=${t}`:""}`)}async fetchGetStudent(e){return await this._callApi(`api/StudentCard/ShowStudentInfo?studentId=${e}`)}async fetchCreateReport(e){await this._callApi(`api/Report/CreateReport?studentId=${e}`)}async fetchCreateYearPlan(e){await this._callApi("api/YearPlan/AddYearPlan",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async fetchUpdateYearPlan(e,t){await this._callApi(`api/YearPlan/UpdateYearPlan?yearPlanId=${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}async fetchGetYearPlan(e,t){return await this._callApi(`api/YearPlan/GetYearPlanByGroup?groupId=${e}&year=${t}`)}async fetchGetProgress(e,t,a){return await this._callApi(`api/Progress/GetProgress?year=${e}&groupId=${t}&semesterId=${a}`)}async fetchUpdateProgress(e){await this._callApi("api/Progress/UpdateProgress",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async fetchGetSpecialities(e){return await this._callApi(`api/StudentCard/GetSpecialities?degreeId=${e}`)}async fetchStudentCardSave(e){await this._callApi("api/StudentCard/SaveStudentCardInfo",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async fetchStudentCardUpdate(e,t){await this._callApi(`api/StudentCard/UpdateStudentCardInfo?studentId=${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}async fetchGetStudentsForTransfer(e,t){return await this._callApi(`api/Transfer/GetStudentsForTransfer?groupId=${e}&year=${t}`)}async fetchUpdateTransferStudents(e){await this._callApi("api/Transfer/TransferStudents",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}}class NotificationHelper{static addNotification(e,t){e={title:notificationTitle[e],text:t,type:e,timeout:notificationTimeout[e]};let a=this._getNotificationElement(e);msgContainer.insertAdjacentElement("beforeend",a),setTimeout(()=>{a.classList.remove("showNotification"),setTimeout(()=>{a.remove()},700)},e.timeout)}static _getNotificationElement(e){let t=`
    ...
    `}function subscribeFormElements(){let e=document.body.querySelectorAll(".form-element-field");e.forEach(e=>e.addEventListener("change",e=>{let t=e.target;t.classList[t.value?"add":"remove"]("-hasValue")}))}const optionDefault='<option class="form-select-placeholder" value="" disabled selected></option>';class Page{constructor(){}static getPage(){return"not implemented"}static init(){console.log("not initialized")}static get is(){return"Page"}static _idsToClear(){return[]}}class MainPage extends Page{constructor(){super()}static get page(){return`
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static buttons={remove:"<i class='remove fas fa-minus-square' onClick='CurriculumAddPage.removeGroupFromList(this)'></i>"};static removeGroupFromList(e){const t=e.closest(".group__item");t.remove()}static _groupCardSubscribe(){const t=document.querySelector(".curriculum__find-groups"),e=document.querySelector(".curriculum__table"),a=document.querySelector(".curriculum__table-row-last"),l=document.querySelector("#add-row-btn"),i=document.querySelector("#year"),r=document.querySelector("#plan-name"),s=document.querySelector("#course"),o=document.querySelector("#group"),n=document.querySelector(".curriculum-group__btn-add"),d=document.querySelector(".curriculum__info-add-btn");i.addEventListener("change",()=>{console.log("year")}),s.addEventListener("change",()=>{!async function(e){if(""!=e){const t=await getGroupsAsOptions(e);o.innerHTML=t.join(""),o.classList.remove("-hasValue")}}(s.value)}),n.addEventListener("click",()=>{var e=getGroupItemWithButton(o.options[group.selectedIndex].text,o.value,CurriculumAddPage.buttons.remove);e&&t.insertAdjacentHTML("beforeend",e)}),d.addEventListener("click",()=>{if(""==i||""==r)return alert("bad");let l={subjectInfo:[]},s=e.querySelectorAll(".curriculum__table-row-data");for(let e=0;e<s.length;e++){let t=s[e].querySelectorAll("[data-table-key]"),a={};for(let e=0;e<t.length;e++)"SELECT"!=t[e].tagName&&"INPUT"!=t[e].tagName||""!=t[e].value?a[t[e].getAttribute("data-table-key")]=t[e].value:a[t[e].getAttribute("data-table-key")]=null;l.subjectInfo.push(a)}l.name=r.value,l.year=i.value,l.groupIds=[...t.children].map(e=>+e.getAttribute("data-group-id")).filter((e,t,a)=>a.indexOf(e)===t),async function(e){apiHelper.fetchCreateYearPlan(e)}(l)});l.addEventListener("click",()=>{a.insertAdjacentHTML("beforebegin",addCurriculumRow())})}}class CurriculumShowPage extends Page{constructor(){super()}static get is(){return"curriculum--show-page"}static get page(){return`
            <div class="curriculum__grid">
        ...
        `}static init(){this._subscribePageElements(),subscribeFormElements()}static _subscribePageElements(){const i=document.querySelector(".curriculum__table"),l=document.querySelector(".curriculum__table-row-last"),e=document.querySelector("#add-row-btn"),s=document.querySelector("#plan-id"),r=document.querySelector("#plan-name"),t=document.querySelector("#year"),a=document.querySelector("#course"),o=document.querySelector("#group"),n=document.querySelector(".curriculum__btn-find"),d=document.querySelector(".curriculum-info__btn-edit"),c=document.querySelector(".curriculum-info__btn-save");t.addEventListener("change",()=>{u(a.value,t.value)}),a.addEventListener("change",()=>{u(a.value,t.value)}),n.addEventListener("click",()=>{!async function(e,t){if(""!=e&&""!=t){!function(){var e=i.querySelectorAll(".curriculum__table-row-data");for(var t of e)t.remove()}();const a=await apiHelper.fetchGetYearPlan(e,t);console.log(a),s.value=a.id,s.classList.add("-hasValue"),r.value=a.name,r.classList.add("-hasValue"),a.subjectInfo.forEach(e=>{l.insertAdjacentHTML("beforebegin",addCurriculumRow(e))})}}(o.value,t.value)}),d.addEventListener("click",()=>{let e=i.querySelectorAll("[data-is-disabled]");e.forEach(e=>{e.disabled=!e.disabled})}),c.addEventListener("click",()=>{!async function(e){if(""!=e){let l={id:e,name:r.value,year:t.value,groupdIds:[o.value],subjectInfo:[]},s=i.querySelectorAll(".curriculum__table-row-data");for(let e=0;e<s.length;e++){let t=s[e].querySelectorAll("[data-table-key]"),a={};for(let e=0;e<t.length;e++)"SELECT"!=t[e].tagName&&"INPUT"!=t[e].tagName||""!=t[e].value?a[t[e].getAttribute("data-table-key")]=t[e].value:a[t[e].getAttribute("data-table-key")]=null;l.subjectInfo.push(a)}apiHelper.fetchUpdateYearPlan(e,l)}}(s.value)});async function u(e,t){if(""!=e&&""!=t){const a=await getGroupsAsOptions(e,t);o.innerHTML=a.join(""),o.classList.remove("-hasValue")}}e.addEventListener("click",()=>{e.hasAttribute("disabled")||l.insertAdjacentHTML("beforebegin",addCurriculumRow())})}}class GroupAddPage extends Page{constructor(){super()}static get is(){return"group--add-page"}static get page(){return`
