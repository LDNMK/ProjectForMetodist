function initSidebar(){let e=document.body.querySelectorAll("a[data-page*='-page'"),t=document.body.querySelectorAll(".sidebar__menu-item");e.forEach(e=>{e.addEventListener("click",e=>{setPageByAttribute(e.target.getAttribute("data-page")),t.forEach(e=>e.classList.remove("active")),e.target.closest(".sidebar__menu-item").classList.add("active")})})}function getGroupItemWithButton(e,t,a){return""==t||""==e||null==a?null:`
    ...
    `}function subscribeFormElements(){let e=document.body.querySelectorAll(".form-element-field");e.forEach(e=>e.addEventListener("change",e=>{let t=e.target;t.classList[t.value?"add":"remove"]("-hasValue")}))}const optionDefault='<option class="form-select-placeholder" value="" disabled selected></option>';class Page{constructor(){}static getPage(){return"not implemented"}static init(){console.log("not initialized")}static get is(){return"Page"}static _idsToClear(){return[]}}class MainPage extends Page{constructor(){super()}static get page(){return`
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static buttons={remove:"<i class='remove fas fa-minus-square' onClick='CurriculumAddPage.removeGroupFromList(this)'></i>"};static removeGroupFromList(e){const t=e.closest(".group__item");t.remove()}static _groupCardSubscribe(){const t=document.querySelector(".curriculum__find-groups"),e=document.querySelector(".curriculum__table"),a=document.querySelector(".curriculum__table-row-last"),l=document.querySelector("#add-row-btn"),o=document.querySelector("#year"),i=document.querySelector("#plan-name"),s=document.querySelector("#course"),r=document.querySelector("#group"),n=document.querySelector(".curriculum-group__btn-add"),d=document.querySelector(".curriculum__info-add-btn");o.addEventListener("change",()=>{console.log("year")}),s.addEventListener("change",()=>{!async function(t){if(""!=t){const a=await fetch(`api/Group/GetGroups?course=${t}`),l=await a.json();let e=l.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),r.innerHTML=e.join(""),r.classList.remove("-hasValue")}}(s.value)}),n.addEventListener("click",()=>{var e=getGroupItemWithButton(r.options[group.selectedIndex].text,r.value,CurriculumAddPage.buttons.remove);e&&t.insertAdjacentHTML("beforeend",e)}),d.addEventListener("click",()=>{if(""==o||""==i)return alert("bad");let l={subjectInfo:[]},s=e.querySelectorAll(".curriculum__table-row-data");for(let e=0;e<s.length;e++){let t=s[e].querySelectorAll("[data-table-key]"),a={};for(let e=0;e<t.length;e++)"SELECT"!=t[e].tagName&&"INPUT"!=t[e].tagName||""!=t[e].value?a[t[e].getAttribute("data-table-key")]=t[e].value:a[t[e].getAttribute("data-table-key")]=null;l.subjectInfo.push(a)}l.name=i.value,l.year=o.value,l.groupIds=[...t.children].map(e=>+e.getAttribute("data-group-id")).filter((e,t,a)=>a.indexOf(e)===t),console.log(l),async function(e){e=await fetch("api/YearPlan/AddYearPlan",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});console.log(e)}(l)});l.addEventListener("click",()=>{a.insertAdjacentHTML("beforebegin",addCurriculumRow())})}}class CurriculumShowPage extends Page{constructor(){super()}static get is(){return"curriculum--show-page"}static get page(){return`
            <div class="curriculum__grid">
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static _groupCardSubscribe(){const e=document.querySelector(".group__add__btn-save"),l=document.querySelector("#name");e.addEventListener("click",()=>{!async function(e){var t=document.querySelectorAll(".form-has-error");t.length?console.log("You should fix errors on the page!"):l.value?await fetch(`api/Group/CreateGroup?groupName=${e}`,{method:"POST"}):l.closest(".form-element").classList.add("form-has-error")}(l.value)}),l.addEventListener("change",e=>{let t=l.value,a=e.target.closest(".form-element");a.classList[0<t.length&&2!=t.split("-").length?"add":"remove"]("form-has-error")})}}class GroupActualizePage extends Page{constructor(){super()}static get is(){return"group--actualize-page"}static get page(){return`
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static _groupCardSubscribe(){const e=document.querySelector("#course"),t=document.querySelector("#year"),o=document.querySelector("#group"),i=document.querySelector("#student"),a=document.querySelector(".create-report__create-btn");e.addEventListener("change",()=>{l(e.value,t.value)}),t.addEventListener("change",()=>{l(e.value,t.value)}),o.addEventListener("change",()=>{!async function(t,a){if(""!=t){""==a&&alert("write year");const l=await fetch(`api/StudentCard/GetStudents?groupId=${t}&year=${a}`),s=await l.json();let e=s.map(e=>`<option value=${e.studentId}>${e.studentName}</option>`);e.push(optionDefault),i.innerHTML=e.join(""),i.classList.remove("-hasValue")}}(o.value,t.value)}),a.addEventListener("click",()=>{!async function(e){if(""!=e){const t=await fetch(`api/Report/CreateReport?studentId=${e}`);await t.json()}}(i.value)});async function l(t,a){if(""!=t&&""!=a){const l=await fetch(`api/Group/GetGroups?course=${t}&year=${a}`),s=await l.json();console.log(s);let e=s.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),o.innerHTML=e.join(""),o.classList.remove("-hasValue"),i.value="",i.innerHTML=optionDefault,i.classList.remove("-hasValue")}}}}class ProgressPage extends Page{constructor(){super()}static get is(){return"progress--page"}static get page(){return`
