function initSidebar(){let e=document.body.querySelectorAll("a[data-page*='-page'");e.forEach(e=>{e.addEventListener("click",e=>{setPageByAttribute(e.target.getAttribute("data-page"))})})}function subscribeFormElements(){let e=document.body.querySelectorAll(".form-element-field");e.forEach(e=>e.addEventListener("change",e=>{let l=e.target;l.classList[l.value?"add":"remove"]("-hasValue")}))}const optionDefault='<option class="form-select-placeholder" value="" disabled selected></option>';class Page{constructor(){}static getPage(){return"not implemented"}static init(){console.log("not initialized")}static is(){return"Page"}static _idsToClear(){return[]}}class MainPage extends Page{constructor(){super()}static getPage(){return`
            <h1>Main page</h1>
        `}static subscribe(){super.subscribe()}static is(){return"main--page"}}function initMainPage(){setPageByAttribute(MainPage.is())}class StudentCardAddPage extends Page{constructor(){super()}static _dataObjKeyFields=null;static is(){return"student-card--add-page"}static getPage(){return`
        ...
        `}static init(){this._initDataObjKeyFields(),this._studentCardSubscribe(),subscribeFormElements()}static _initDataObjKeyFields(){this._dataObjKeyFields=content.querySelectorAll("[data-obj-key]")}static _studentCardSubscribe(){const o=document.querySelector("#group"),e=document.querySelector("#course"),s=document.querySelector("#student"),l=document.querySelector("#year");clearBtn.addEventListener("click",()=>{let e=this._idsToClear(),l=document.querySelectorAll(e.join(", "));l.forEach(e=>{e.classList.remove("-hasValue"),e.value=""})}),findBtn.addEventListener("click",()=>{!async function(e){if(""!=e){const l=await fetch(`api/StudentCard/ShowStudentInfo?studentId=${e}`),t=await l.json();StudentCardShowPage._dataObjKeyFields.forEach(e=>{e.value=t[e.getAttribute("data-obj-key")],e.classList.add("-hasValue")}),console.log(t)}}(s.value)}),editBtn.addEventListener("click",()=>{console.log("Edit")}),saveBtn.addEventListener("click",()=>{!async function(e){let l={};StudentCardShowPage._dataObjKeyFields.forEach(e=>{l[e.getAttribute("data-obj-key")]=e.value}),console.log(l);await fetch(`api/StudentCard/UpdateStudentCardInfo?studentId=${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(l)})}(s.value)}),averageScoreBtn.addEventListener("click",()=>{console.log("Average score")}),l.addEventListener("change",()=>{t(l.value,e.value)}),e.addEventListener("change",()=>{t(l.value,e.value)}),o.addEventListener("change",()=>{!async function(l){if(""!=l){const t=await fetch(`api/StudentCard/GetListOfStudents?groupId=${l}`),a=await t.json();let e=a.map(e=>`<option value=${e.studentId}>${e.studentName}</option>`);e.push(optionDefault),s.innerHTML=e.join(""),s.classList.remove("-hasValue")}}(o.value)});async function t(l,t){if(""!=l&&""!=t){const a=await fetch(`api/Group/GetListOfGroups?course=${t}&year=${l}`),s=await a.json();console.log(s);let e=s.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),o.innerHTML=e.join(""),o.classList.remove("-hasValue")}}l.value=2021,l.classList.add("-hasValue"),e.value="1",e.classList.add("-hasValue");var a=new Event("change");e.dispatchEvent(a)}static _idsToClear(){return["#speciality","#specialization","#year","#course","#group","#student"]}}class StudentCardShowPage extends Page{constructor(){super()}static _dataObjKeyFields=null;static is(){return"student-card--show-page"}static getPage(){return`
        ...
        `}static init(){this._initDataObjKeyFields(),this._studentCardSubscribe(),subscribeFormElements()}static _initDataObjKeyFields(){this._dataObjKeyFields=content.querySelectorAll("[data-obj-key]")}static _studentCardSubscribe(){const e=document.querySelector(".student-card__show-btn-clear"),l=document.querySelector(".student-card__show-btn-find"),t=document.querySelector(".student-card__show-btn-edit"),a=document.querySelector(".student-card__show-btn-save"),s=document.querySelector(".student-card__show-average-score-btn"),o=document.querySelector("#group"),i=document.querySelector("#course"),n=document.querySelector("#student"),d=document.querySelector("#year");e.addEventListener("click",()=>{let e=this._idsToClear(),l=document.querySelectorAll(e.join(", "));l.forEach(e=>{e.classList.remove("-hasValue"),e.value=""})}),l.addEventListener("click",()=>{!async function(e){if(""!=e){const l=await fetch(`api/StudentCard/ShowStudentInfo?studentId=${e}`),t=await l.json();StudentCardShowPage._dataObjKeyFields.forEach(e=>{e.value=t[e.getAttribute("data-obj-key")],e.classList.add("-hasValue")}),console.log(t)}}(n.value)}),t.addEventListener("click",()=>{console.log("Edit")}),a.addEventListener("click",()=>{!async function(e){let l={};StudentCardShowPage._dataObjKeyFields.forEach(e=>{l[e.getAttribute("data-obj-key")]=e.value}),console.log(l);await fetch(`api/StudentCard/UpdateStudentCardInfo?studentId=${e}`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(l)})}(n.value)}),s.addEventListener("click",()=>{console.log("Average score")}),d.addEventListener("change",()=>{r(d.value,i.value)}),i.addEventListener("change",()=>{r(d.value,i.value)}),o.addEventListener("change",()=>{!async function(l){if(""!=l){const t=await fetch(`api/StudentCard/GetListOfStudents?groupId=${l}`),a=await t.json();let e=a.map(e=>`<option value=${e.studentId}>${e.studentName}</option>`);e.push(optionDefault),n.innerHTML=e.join(""),n.classList.remove("-hasValue")}}(o.value)});async function r(l,t){if(""!=l&&""!=t){const a=await fetch(`api/Group/GetListOfGroups?course=${t}&year=${l}`),s=await a.json();console.log(s);let e=s.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);e.push(optionDefault),o.innerHTML=e.join(""),o.classList.remove("-hasValue")}}d.value=2021,d.classList.add("-hasValue"),i.value="1",i.classList.add("-hasValue");var c=new Event("change");i.dispatchEvent(c)}static _idsToClear(){return["#speciality","#specialization","#year","#course","#group","#student"]}}let content=document.body.querySelector(".main__content");content||console.log("Tag with class'main__content' not found!");const mapper={"main--page":MainPage,"student-card--add-page":StudentCardAddPage,"student-card--show-page":StudentCardShowPage};function setPageByAttribute(l){if(l in mapper){let e=mapper[l];content.innerHTML=e.getPage(),e.init()}else console.log(`Tag with attribute data-page='${l}' not found!`)}function init(){initSidebar()}init();