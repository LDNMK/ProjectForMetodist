function initSidebar(){let e=document.body.querySelectorAll("a[data-page*='-page'");e.forEach(e=>{e.addEventListener("click",e=>{setPageByAttribute(e.target.getAttribute("data-page"))})})}function subscribeFormElements(){let e=document.body.querySelectorAll(".form-element-field");e.forEach(e=>e.addEventListener("change",e=>{let t=e.target;t.classList[t.value?"add":"remove"]("-hasValue")}))}const optionDefault='<option class="form-select-placeholder" value="" disabled selected></option>';class Page{constructor(){}static getPage(){return"not implemented"}static init(){console.log("not initialized")}static get is(){return"Page"}static _idsToClear(){return[]}}class MainPage extends Page{constructor(){super()}static get page(){return`
        ...
        `}static init(){this._groupCardSubscribe(),subscribeFormElements()}static _groupCardSubscribe(){let o=document.querySelector(".group__actualize-items"),a=document.querySelector("#group");const e=document.querySelector(".group__actualize-btn-add"),t=document.querySelector(".group__actualize-btn-actualize");e.addEventListener("click",()=>{!function(a,s){if(""!=s&&""!=a){let e=document.createElement("li");e.classList.add("group__actualize-item"),e.setAttribute("data-group-id",s);let t=document.createElement("i");t.classList.add("fas","fa-minus-square"),t.addEventListener("click",()=>{o.removeChild(e)});let l=document.createElement("span");l.innerText=a,e.insertAdjacentElement("beforeend",t),e.insertAdjacentElement("beforeend",l),o.insertAdjacentElement("beforeend",e)}}(a.options[a.selectedIndex].text,a.value)}),t.addEventListener("click",()=>{!async function(e){e.length<=0||(await fetch("api/Group/ActivateExistingGroups",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})).ok&&(o.innerHTML="",l())}([...o.children].map(e=>+e.getAttribute("data-group-id")).filter((e,t,l)=>l.indexOf(e)===t))});async function l(){const e=await fetch("api/Group/GetDeactivatedGroups",{method:"GET"}),t=await e.json();let l=t.map(e=>`<option value=${e.groupId}>${e.groupName}</option>`);l.push(optionDefault),a.innerHTML=l.join(""),a.classList.remove("-hasValue")}window.onload=l()}}class TransferPage extends Page{constructor(){super()}static get is(){return"transfer--page"}static get page(){return`
